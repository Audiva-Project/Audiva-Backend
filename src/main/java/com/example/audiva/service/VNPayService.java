...
public class VNPayService {
    ...
    public String generateVNPayURLWithPoints(double amountDouble, String supportPoint, String paymentRef, String ip)
            throws UnsupportedEncodingException {
        ...
        if (amount < 0) {
            throw new IllegalArgumentException("Total amount after applying points cannot be negative.");
        }
        ...
        vnp_Params.put("vnp_CurrCode", "VND");
        vnp_Params.put("vnp_TxnRef", vnp_TxnRef);
        vnp_Params.put("vnp_OrderInfo", "Thanh toan don hang: " + vnp_TxnRef + ", Support Points: " + supportPoint);
        vnp_Params.put("vnp_OrderType", orderType);
        vnp_Params.put("vnp_Locale", "vn");
        vnp_Params.put("vnp_ReturnUrl", vnp_ReturnUrl);
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
